...
8 tools được hỗ trợ, kết nối tới Jira Server tại pm.gem-corp.tech.
...
Trả về: summary, status, description, assignee, reporter, priority, story points, start date, due date, labels, subtasks, comments.
...
- `story_points` (optional): Số story points.
